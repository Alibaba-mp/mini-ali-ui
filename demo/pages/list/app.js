        ...
        components: [
          {
            ...
            list: [
              ...
              },
              {
                ...
                update: true,
                updateDesc: '✍️ tab-content 距离顶部位置可控；tab 高亮判断不准确处理；',
              },
              {
                name: 'Card',
                nameZN: '卡片',
        ...
        components: [
          {
            ...
            list: [
              ...
              },
              {
                ...
                update: true,
                updateDesc: '✍️ 获取 data-xxx 值的问题处理；',
              },
              {
                name: 'Am-switch',
                nameZN: '开关',
              ...
              },
              {
                ...
                update: true,
                updateDesc: '✍️ clear icon 可能无法点击的问题处理；',
              },
            ],
          },
        ],
